  ...
  return (
    <div className={styles.root}>
      ...
      <div className={styles.formulaBanner}>
        ...
        <span className={styles.formulaVal}>{currentExample.bcFormula}</span>
        {currentExample.notes && (
          <span className={styles.formulaNote}>{currentExample.notes}</span>
        )}
      </div>
      ...
      <div className={styles.sliderCard}>
        ...
        <div className={styles.sliderTop}>
          <div>
            ...
            <div className={styles.timeValue}>t = {t.toFixed(2)}</div>
          </div>

          <div className={styles.sliderStats}>
            <div className={styles.statBox}>
              <span className={styles.statLabel}>Step</span>
              <span className={styles.statVal}>{step} / {totalSteps}</span>
            </div>
            <div className={styles.statBox}>
            ...
            <div className={styles.statBox}>
              <span className={styles.statLabel}>v_max on top</span>
              <span className={styles.statVal} style={{ color: 'var(--orange)' }}>
                {vMax.toFixed(3)}
              </span>
            </div>
            <div className={styles.statBox}>
            ...
            >
              {SPEED_OPTIONS.map(ms => (
                <option key={ms} value={ms}>
                  {ms === 1400 ? '0.5×' : ms === 800 ? '1×' : ms === 400 ? '2×' : '4×'}
                </option>
              ))}
            </select>
          </div>
      ...
      <div className={styles.viewerGrid}>
        ...
        <div className={styles.viewerPanel}>
          <div className={styles.viewerHeader}>
            <span className={styles.viewerLabel}>Original Mesh</span>
          ...
          <div className={styles.viewerBody}>
            <ImageFrame
              ...
              onClick={() => setModal({
                src:     currentExample.originalImg,
                caption: 'Original Structured Mesh — 60×60 node grid at t = 0',
              })}
              minHeight="300px"
            />
          </div>
        ...
        <div className={styles.viewerPanel}>
          <div className={styles.viewerHeader}>
            <span className={styles.viewerLabel}>Deformed Mesh</span>
      ...
      {currentExample.overviewImg && (
        <Card
          ...
          badge={<Badge variant="orange">Plasma colormap · Quiver vectors</Badge>}
          noPadding
        >
      ...
      <div className={styles.folderNote}>
        ...
        <div>
          <div className={styles.folderTitle}>Timestep images location</div>
